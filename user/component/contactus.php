                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 pe-lg-0">
                        <div class="contact-info contact-info-border-start d-flex flex-column">
                            ...
                            <p class="mb-0">We are available for freelance projects</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 ps-lg-0">
                        <div class="contact-info d-flex flex-column">
                            ...
                            <p class="mb-2">
                                Psources is a professional web developer. Feel free to get in touch with Our.
                            </p>

                            <strong class="site-footer-title d-block mt-4 mb-3">Email</strong>

                            <p>
                            <a href="mailto:<?php echo $res1[0]['email'];?>">
                                <?php echo $res1[0]['email'];?>
                            </a>
                            ...
                            <p class="mb-0">
                            <a href="tel: <?php echo $res1[0]['phone'];?>">
                                <?php echo $res1[0]['phone'];?>
                            </a>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-floating">
                                        <input type="email" name="email" id="email" pattern="[^ @]*@[^ @]*"
                                            class="form-control" placeholder="Email address" required="yes">
                                ...
                                <div class="col-lg-12 col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" id="message" name="message"
                                            placeholder="Tell me about the project" required></textarea>

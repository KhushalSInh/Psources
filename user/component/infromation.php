                        ...
                        <div class="profile-thumb">
                            ...
                            <div class="profile-body">
                                <p>
                                    ...
                                    <span><?php echo $res1[0]['name'];?></span>
                                </p>

                                <p>
                                    <span class="profile-small-title">Birthday</span>
                                    <span><?php echo $res1[0]['birthdate'];?></span>
                                </p>

                                <p>
                                    <span class="profile-small-title">Phone</span>
                                    <span><a href="tel: <?php echo $res1[0]['phone'];?>"><?php echo $res1[0]['phone'];?></a></span>
                                </p>

                                <p>
                                    <span class="profile-small-title">Email</span>
                                    <span><a href="mailto:<?php echo $res1[0]['email'];?>"><?php echo $res1[0]['email'];?></a></span>
                                </p>
                            </div>
                        </div>
                    </div>

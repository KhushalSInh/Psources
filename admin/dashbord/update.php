...
if (isset($_POST['update'])) {
    ...
    $admin_obj->select("sources", "id = '$uid'");
...
<body>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            <div class="row">
                                <span class="fs-4 col-11 col-sm-11 text-black pb-5">Update SOURCES</span>
                            </div>
                            <div class="container">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group text-start">
                                        ...
                                        <input type="text" class="form-control" name="name"
                                            value="<?php echo $r1[0]['name']; ?>">
                                    </div>
                                    <div class="form-group text-start">
                                        <label for="" class="px-3 mb-2 mt-2 fs-5 fw-bold">Languge:</label>
                                        <input type="text" class="form-control" name="lang"
                                            value="<?php echo $r1[0]['language']; ?>">
                                    </div>
                                    <div class="form-group text-start">
                                        <label for="" class="px-3 mb-2 mt-2 fs-5 fw-bold">File:</label>
                                        <input type="file" class="form-control" name="file1">

                                            <input type="hidden" name="old_path" value="<?php echo $r1[0]['sources']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group mt-5 row">
                                        <div class="col-5">
                                            ...
                                            <input type="hidden" name="id" value="<?php echo $r1[0]['id']; ?>">
                                        </div>
                                        <div class="col-5">
                                            <button type="submit" class="btn btn-success fs-5"
                                                name="update_sources">Update</button>
                                        </div>
                                    </div>
                                </form>
    ...
    if (isset($_POST['update_sources'])) {
        ...
        $r = $admin_obj->update("sources", ['name'=>$name,'language'=>$lang,'sources'=>$path2], "id ='$id'");

        $rr = $admin_obj->getresult();
        if ($rr) {
            ?>
            <script>
                alerts("success", "Update SucessFully", "home.php");
            </script>
            <?php
        }
    }

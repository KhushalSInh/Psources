...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="pidea.php" class="nav-item nav-link active"><i
                            class="bi bi-lightbulb-fill me-2"></i>Project
                        Ideas</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Project Ideas</h6>
                    ...
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                $admin_obj->select("sources","type='project_idea'");
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">    
                                        <form action="" method="post">
                                            <button type="submit" class="btn btn-danger" name="delete_note"><i class="bi bi-x-square-fill"></i></button>
                                            <input type="hidden" name="id" value="<?php echo $val['id'] ?>">
            ...
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLabel">New Project Ideas</h5>
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="submit" name="add_idea" class="btn btn-primary">Add</button>
                  </div>
               </div>
            </div>
         </div>
    ...
    if (isset($_POST['add_idea'])) {
        ...
        $r = $admin_obj->insert("sources", ['name'=>$name,'type'=>'project_idea','language'=>$lang,'sources'=>$path2]);
    
        if (true) {
            ?>
            <script>
                alerts("success", "Add SucessFully", "pidea.php");
            </script>
            <?php
        }
    }
    ...
    if (isset($_POST['delete_idea'])) {
        ...
        if (true) {
            ?>
            <script>
                alerts("success", " Deleted SucessFully", "pidea.php");
            </script>
            <?php
        }
    }

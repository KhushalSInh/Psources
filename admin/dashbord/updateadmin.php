...
<body>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            <div class="row">
                                <span class="fs-4 col-11 col-sm-11 text-black pb-5">Update Admin</span>
                            </div>
                            <div class="container">
                                <form action="" method="post">
                                    ...
                                    <div class="form-group text-start">
                                        ...
                                        <input type="text" class="form-control" name="email-id"
                                            value="<?php echo $r1[0]['email'] ?>">
                                    </div>
                                    <div class="form-group text-start">
                                        <label for="" class="px-3 mb-2 mt-2 fs-5 fw-bold">Password:</label>
                                        <input type="text" class="form-control" name="pas"
                                            value="<?php echo $r1[0]['password'] ?>">
                                    </div>
    ...
    if (isset($_POST['up_admin'])) {
        ...
        $r = $admin_obj->update('admin', ['name' => $name, 'email' => $email, 'password' => $pas], "id ='$id'");

        $rr = $admin_obj->getresult();
        if ($rr) {
            ?>
            <script>
                alerts("success", "Admin Update SucessFully", "admin.php");
            </script>
            <?php
        }
    }

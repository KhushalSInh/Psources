...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="cheetsheet.php" class="nav-item nav-link active"><i
                            class="fa fa-th me-2"></i>CheetSheets</a>
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                $admin_obj->select("sources","type='cheetsheet'");
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">    
                                        <form action="" method="post">
                                            <button type="submit" class="btn btn-danger" name="delete_cs"><i class="bi bi-x-square-fill"></i></button>
                                            <input type="hidden" name="id" value="<?php echo $val['id'] ?>">
            ...
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLabel">New CheetSheet</h5>
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="submit" name="add_cs" class="btn btn-primary">Add</button>
                  </div>
               </div>
            </div>
         </div>
    ...
    if (isset($_POST['add_cs'])) {
        ...
        $r = $admin_obj->insert("sources", ['name'=>$name,'type'=>'cheetsheet','language'=>$lang,'sources'=>$path2]);
    
        if (true) {
            ?>
            <script>
                alerts("success", "Add SucessFully", "cheetsheet.php");
            </script>
            <?php
        }
    }
    ...
    if (isset($_POST['delete_cs'])) {
        ...
        if (true) {
            ?>
            <script>
                alerts("success", " Deleted SucessFully", "cheetsheet.php");
            </script>
            <?php
        }
    }

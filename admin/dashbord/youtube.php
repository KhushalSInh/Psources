...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="youtube.php" class="nav-item nav-link active"><i class="bi bi-youtube me-2"></i>Youtube</a>
                    ...
                    <a href="main.php" class="nav-item nav-link"><i class="bi bi-envelope me-2"></i>Mail</a>
                    ...
                    <a href="../logout.php" class="nav-item nav-link"><i
                            class="bi bi-box-arrow-in-left me-2 fs-5"></i>Log
                        Out</a>
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                $admin_obj->select("sources","type='yt'");
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">    
                                        <form action="" method="post">
                                            <button type="submit" class="btn btn-danger" name="delete_yt"><i class="bi bi-x-square-fill"></i></button>
                                            <input type="hidden" name="id" value="<?php echo $val['id'] ?>">
            ...
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLabel">New Youtube source</h5>
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="submit" name="add_yt" class="btn btn-primary">Add</button>
                  </div>
               </div>
            </div>
         </div>
    ...
    if (isset($_POST['add_yt'])) {
        ...
        $r = $admin_obj->insert("sources", ['name'=>$name,'type'=>'yt','language'=>$lang,'sources'=>$path2]);
    
        if (true) {
            ?>
            <script>
                alerts("success", "Add SucessFully", "youtube.php");
            </script>
            <?php
        }
    }
    ...
    if (isset($_POST['delete_yt'])) {
        ...
        if (true) {
            ?>
            <script>
                alerts("success", " Deleted SucessFully", "youtube.php");
            </script>
            <?php
        }
    }

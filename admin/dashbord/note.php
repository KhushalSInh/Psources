...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="note.php" class="nav-item nav-link active "><i class="bi bi-book-half me-2"></i>Notes</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                $admin_obj->select("sources","type='note'");
    ...
    if (isset($_POST['add_note'])) {
        ...
        $r = $admin_obj->insert("sources", ['name'=>$name,'type'=>'note','language'=>$lang,'sources'=>$path2]);
    
        if (true) {
            ?>
            <script>
                alerts("success", "Add SucessFully", "note.php");
            </script>
            <?php
        }
    }
    ...
    if (isset($_POST['delete_note'])) {
        ...
        if (true) {
            ?>
            <script>
                alerts("success", " Deleted SucessFully", "note.php");
            </script>
            <?php
        }
    }
